...
3. **ビジュアル探索（2～3日）:** ムードボードを3方向作り、「可読性」「固有性」「制作コスト」「拡張性」で採点する。採用案から色、書体、盤面記号、アイコン、効果音の原則を1ページのスタイルタイルにまとめる
...
* **画像生成・イラスト制作者:** ムードボードや背景テクスチャの発散には画像生成を使えるが、最終 UI アイコン、状態記号、文字入り画像は人が整え、権利と生成履歴を記録する。ゲーム判断に必要な記号は SVG または CSS で管理する
